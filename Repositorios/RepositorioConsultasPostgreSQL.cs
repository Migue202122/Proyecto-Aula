...
namespace ProyectoAula.Repositorios 
{
...
{ 
    ...
    return lista; 
        ...
        { 
            ...
            { 
                ...
                { 
                    ...
                    else if (nombreParam.Contains("roles") || nombreParam.Contains("detalles") || nombreParam.Contains("json") || nombreParam.Contains("data")) 
                    { 
        ...
        private async Task<List<Dictionary<string, object?>>> ObtenerForeignKeysTablaAsync(NpgsqlConnection conexion, string 
nombreTabla) 
        { 
