    ...
    { 
        ...
        { 
            ...
            { 
                ...
                // ============================================================ 
                else if ((meta.Tipo.ToLower() == "varchar" || meta.Tipo.ToLower() == "nvarchar" || meta.Tipo.ToLower() == "char" || meta.Tipo.ToLower() == "nchar") && valor != DBNull.Value) 
                { 
                    string valorStr = valor.ToString() ?? string.Empty; 
        ...
        { 
            ...
            string sql = @" 
                SELECT 
                    ...
                    QUOTENAME(c.TABLE_NAME)), c.COLUMN_NAME, 'IsIdentity') = 1 THEN 'YES' ELSE 'NO' END AS is_identity, 
